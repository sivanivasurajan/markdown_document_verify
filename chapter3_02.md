...
*Image content: A winding road with six stops labeled "Establish Framework", "Perform Assessment", "Prioritize Measures", "Draft Decarbonization Plan", "Implement Decarbonization Plan", and "Track and Report Performance".*
...
*Image content: A cross-section of a building showing various systems, including community wind turbines, efficient heat pump HVAC, high-performance envelope, high-performance windows, building controls, efficient electric water heater, onsite renewables and storage, efficient electric appliances and lighting.*
...
*Image content: U.S. EPA eGRID Database, NREL Cambium Database, UNFCCC Harmonized Grid Emission Factor Data Set, Other International Emission Factors.*
...
*Image content: A circular diagram with an inner and outer circle, showing end-use breakdown by energy and GHG emissions, with labels: Heating, Cooling, Lighting, Fans, Pumps, Plug Loads, Elevators, Hot Water, Heat Rejection.*

**[Figure: Electricity demand annual heat map]**
*Image content: A horizontal heat map with a vertical axis labeled "Hour of Day" and a horizontal axis labeled "Day of Year", displaying a range of colors from blue to red, with a color bar on the right side indicating the corresponding kilowatt (kW) values.*

# Chapter 3: Path for Existing Building Decarbonization

**[Figure: Average hourly building demand vs. grid emission factors]**
*Image content: A line graph with three lines representing net building demand (with PV), marginal carbon, and high carbon and cost hours, plotted against hours of the day on the x-axis and an unlabeled y-axis, with a yellow shaded area indicating high carbon and cost hours.*
...
*Image content: A cover page with a cityscape and power lines, featuring the title "Grid-Interactive Buildings for Decarbonization" and the subtitle "Design and Operation Resource Guide" in white text on a blue and green background.*
...
*Image content: A bar chart with a white background, showing the laboratory measured loads in kilo-British thermal units per hour (kBTU/hr) on the y-axis, ranging from -8000 to 22000, and time on the x-axis, with four colored bars representing different loads: blue for cooling, red for heating, yellow for simultaneous heating, and orange for simultaneous cooling.*
...
**[Figure: A building and a path]**
*Image content: A white building with a flat roof and a path leading to it, surrounded by trees and a body of water.*
...
**[Figure: Tool/Resource and Intended Use During Assessment]**
*Image content: A table with two columns, "Tool/Resource" and "Intended Use During Assessment", listing various tools and resources for building energy efficiency, including DOE GHG Emissions Reduction Audit Checklist, DOE Asset Score/Audit Template, GHG Protocol Emission Inventory Calculation Tools, Embodied Carbon Construction Calculator, Electrification Impact Calculator, EnergyPlus, URBANopt, Energy Charting and Metrics Tool, REopt, DER-CAM, and Refrigerant Impact Calculator.*
...
*Image content: A table with two columns, "Characteristic" and "Guidance for Selection of Characteristic", listing various characteristics such as GHG emissions intensity, site energy use intensity, total energy use, planned renovations/equipment end-of-life, building type, on-site fossil fuel combustion, HVAC system type, climate zone, ownership structure, disadvantaged communities, energy prices, regulatory drivers, utility grid carbon intensity, and utility incentives and funding opportunities.*
...
*Image content: A horizontal flowchart with 9 steps, from left to right: Foundational Data, Building Upgrades, Maximize Energy Efficiency, Electrify Space Conditioning and Water Heating Systems, Optimize Building Automation Systems and Grid Interactivity, Assess Distributed Generation and Clean Power Production, Utilize Energy Storage, Integrate Grid Interactivity and/or Microgrids, and Evaluate Financial Considerations.*
...
**[Figure: Framework for building decarbonization assessment]**
*Image content: A flowchart with 5 stages: "Building Characteristics", "Energy Use", "Energy Efficiency", "Renewable Energy", and "Carbon Emissions" — each stage has a corresponding icon and is connected by arrows indicating the flow of information.*

**[Figure: Sample building annual heat load profile.]**
*Image content: A bar chart showing the cumulative annual percent therm consumption (y-axis) versus the percent of design load (x-axis), with a line graph of annual load within percent load bin (y-axis) versus percent of design load (x-axis), and three images of a chiller unit with green, blue, and red annotations.*
...
*Image content: A vertical flowchart with green boxes and red and blue arrows, starting with "Follow Capital Plan Upgrade Schedule" and ending with "Add to Capital Plan for future retrofit trigger", with stages including "Upgrade in the current Capital Plan?", "Will retrofit meet loads (e.g. HHW temps)?", "Pursue electric, heating and cooling load reduction", and "Can the building accommodate new electric equipment?".*

**[Figure: Decision tree: Determining when to electrify equipment.]**
*Image content: A vertical flowchart with the following stages: Start Process, Energy Source, Decision, End Process.*
...
*Image content: A book cover with a blue and green background, featuring a cityscape and a wind turbine, and the title "Grid-Interactive Buildings for Decarbonization: Design and Operation Resource Guide" in white text.*
...
*Image content: A bar chart comparing the cumulative emissions reduction measures of two packages of measures, with a table above listing the maintainability, complexity, resilience, and technology readiness of each package.*

**[Figure: Example comparison of ERM packages.]**
*Image content: A bar chart comparing the cumulative emissions reduction measures of two ERM packages, with the x-axis labeled "Package of Measures" and the y-axis labeled "CO2-equivalent Emissions (% of Baseline Emissions)". The chart shows the emissions reduction measures for each package, with the first package having a higher reduction in emissions than the second package.*
...
*Image content: A horizontal timeline with red dots marking years 2022, 2023, 2027, 2028, and 2030, and corresponding labels: "Data Strategy - Connect Everything", "Replace Primary AHU with High Energy Recovery", "Deep Retrofit Floors - 2,3,7, 8, & 9", "Move To Ambient Loop (Add ASHP And Dry Coolers)", "Enable Data And AI Solutions", "Connect Thermal Storage - Water Tanks", "Connect To 555 GW To Share Energy", "Deep Retrofit Floors - 10, 11, 13, 16, & 17", "Deep Retrofit Floors - 4, 5, 6, 12, 14, & 15", and "Complete Ambient Loop - 100% Electric Building".*
...
*Image content: Cover of a document titled "Framework for Greenhouse Gas Emissions Reduction Planning: Building Portfolios" with a photo of skyscrapers and a logo for the Better Climate Challenge.*
...
*Image content: A logo with a blue cityscape and a map pin, accompanied by the text "BETTER" and "BUILDING EFFICIENCY TARGETING TOOL FOR ENERGY RETROFITS", and a paragraph of text describing the tool's purpose and features.*
...
*Image content: A line graph showing the historical emissions from 2020 to 2021, and four scenarios for reducing emissions from 2022 to 2040: Scenario 1 (Deep Efficiency, Deep Electrification), Scenario 2 (Deep Efficiency, Moderate Electrification), Scenario 3 (Moderate Efficiency, Deep Electrification), and Scenario 4 (Moderate Efficiency, Moderate Electrification), with two reduction targets: 50% and 80%.*
...
*Image content: A table with six columns and ten rows, listing various building systems and their benefits, including Roof Insulation, Windows/Doors, Air Sealing & Weatherization, Exterior Wall Insulation, Heating System Upgrades, Electrify Heating, Pipe Insulation, Ventilation Upgrades, Electrify Hot Water Heating, Plumbing Fixture Upgrades, Common Area & Exterior Upgrades, In-Unit Upgrades, Appliance Upgrades, Electrify Cooking, Electrify Laundry, and Solar PV.*

**[Figure: Example benefits & impacts matrix for prioritization and implementation planning.]**
*Image content: A table with columns for costs, lifespan, maintenance, tenant disruption, when to implement, and future refi, listing various upgrades with their corresponding values, including medium and high impacts, and low and medium lifespans.*
...
*Image content: Two workers in orange and blue hard hats inspecting electrical equipment on a rooftop.*
