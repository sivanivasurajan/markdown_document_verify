...
- **Subtitle**: The subtitle is "Shaping Tomorrow's Built Environment Today."
- **Logo**: The ASHRAE logo is displayed at the top left corner of the document.
- **Text**: The document contains several paragraphs of text that outline ASHRAE's position on building decarbonization.
- **Bullet Points**: The document includes bullet points that summarize the key points of ASHRAE's position.
- **Footnotes**: The document includes footnotes that provide additional information and references.

This document is a valuable resource for anyone interested in learning more about ASHRAE's position on building decarbonization and how it can be achieved through a holistic approach that considers multiple factors.
...
Description: This chart compares the energy-related CO2 emissions in 2020 across different sectors, providing a key insight into the distribution of emissions.
...
Description: This diagram illustrates the various stages of a building's life cycle, from raw material supply to end-of-life disposal or recycling. It categorizes these stages into three main groups: embodied, operational, and circular economy.

Key Elements:

- **Embodied**: This section includes the product stage (A1-A3), construction stage (A4-A5), use stage (B1-B7), and end-of-life stage (C1-C4). Each stage is further divided into specific activities such as raw material supply, manufacturing, transport to site, construction and installation process, maintenance, repair, replacement, refurbishment, deconstruction/demolition, transport to waste processing/disposal, waste processing, and disposal of waste.

- **Operational**: This part focuses on operational energy use (B6) and operational water use (B7).

- **Circular Economy**: It highlights the benefits and loads of the building life cycle stage (D), emphasizing reuse, recovery, recycling, and potential.

This diagram provides a comprehensive overview of the environmental impacts associated with the entire life cycle of a building, from initial construction to eventual disposal or recycling.
...
Description: This diagram illustrates the steps involved in achieving decarbonization for existing buildings. It outlines a comprehensive process from establishing a framework to implementing a decarbonization plan and tracking performance.
...
*   High-Performance Envelope -> Reduce heat loss and gain through advanced insulation and window technologies
*   High-Performance Windows -> Minimize heat transfer and reduce energy losses
*   Building Controls -> Optimize energy usage and monitor building performance
*   Efficient Electric Water Heater -> Heat water efficiently using electricity
*   Efficient Electric Appliances and Lighting -> Reduce energy consumption through the use of energy-efficient appliances and lighting

This diagram provides a comprehensive overview of the building systems involved in decarbonization, emphasizing the importance of integrating renewable energy sources, energy-efficient technologies, and smart controls to achieve a more sustainable built environment.
...
**[Figure: End-Use Breakdown]**

Type: diagram

Description: The diagram presents a comprehensive breakdown of end-use energy consumption and greenhouse gas (GHG) emissions, categorized into various sectors. The inner circle represents energy usage, while the outer circle illustrates GHG emissions.

Key Elements:

* Heating -> Accounts for the largest share of both energy consumption and GHG emissions.
* Cooling -> Represents a significant portion of energy usage but has a relatively lower impact on GHG emissions.
* Lighting -> Contributes moderately to both energy consumption and GHG emissions.
* Fans -> Has a minimal impact on both energy usage and GHG emissions.
* Pumps -> Accounts for a small percentage of energy consumption and GHG emissions.
* Plug Loads -> Represents a notable share of energy usage but has a relatively lower impact on GHG emissions.
* Elevators -> Contributes minimally to both energy consumption and GHG emissions.
* Hot Water -> Accounts for a moderate percentage of energy usage and GHG emissions.
* Heat Rejection -> Has a significant impact on both energy consumption and GHG emissions.

This diagram provides valuable insights into the distribution of energy consumption and GHG emissions across different sectors, highlighting areas for potential improvement and optimization.

**[Figure: Example electricity demand annual heat map]**

Type: heat map

Description: This heat map illustrates the annual electricity demand, with the x-axis representing the day of the year and the y-axis representing the hour of the day. The color scale on the right indicates the level of electricity demand, ranging from -20 kW (blue) to 50 kW (red). The heat map shows a clear pattern of higher electricity demand during the summer months (June to August) and lower demand during the winter months (December to February). The highest demand is observed during the peak summer hours (12 pm to 6 pm), while the lowest demand is seen during the early morning hours (2 am to 6 am) throughout the year.

Key Elements:

*   Color scale: represents the level of electricity demand
*   X-axis: represents the day of the year
*   Y-axis: represents the hour of the day

This heat map provides valuable insights into the annual electricity demand patterns, highlighting the importance of considering seasonal variations in energy consumption.

**[Figure: Average hourly building demand vs. grid emission factors]**

Type: chart

Description: This line chart compares the average hourly building demand with grid emission factors, specifically focusing on net building demand (with PV), marginal carbon, and high carbon and cost hours. The key insight is that there is a significant variation in these factors throughout the day, with peaks and troughs that can inform energy management strategies.
...
*   X-axis: Hour
*   Y-axis: Energy demand and carbon emissions
...
This chart provides valuable insights into the relationship between building energy demand and grid emission factors, highlighting opportunities for optimizing energy usage and reducing carbon footprint.
...
Description: The figure depicts a cityscape with a prominent power line tower in the foreground, set against a backdrop of skyscrapers and buildings. The image is overlaid with a blue-green gradient, suggesting a focus on environmental sustainability.

Key Elements:

* Power line tower -> represents the infrastructure for transmitting electricity
* Cityscape -> illustrates the urban context where grid-interactive buildings are being implemented
* Blue-green gradient -> symbolizes the integration of renewable energy sources and sustainable practices in building design

This diagram likely serves as a visual representation of the concept of grid-interactive buildings and their role in decarbonization efforts within urban environments.
...
Description: This chart compares the heating and cooling loads of a building over time, highlighting the thermal overlap between the two. The key insight is that there are periods where both heating and cooling are required simultaneously.

Data Representation:

* Heating: 2000-8000 kBtu/hr
* Cooling: 0-22000 kBtu/hr
...
* X-axis: Time (hours)
* Y-axis: Energy consumption (kBtu/hr)
...

{
  ...
  "units": "kBtu/hr",
  "data": {
    "heating": [2000, 4000, 6000, 8000],
    "cooling": [0, 10000, 15000, 20000]
  }}
}
...
Description: This diagram presents a step-by-step framework for assessing and optimizing building decarbonization. It outlines a structured approach to evaluating energy efficiency, integrating renewable energy sources, and implementing sustainable practices in building operations.

Key Elements:

- **Step 1: Foundational Data** -> Collect and analyze data on building energy consumption and performance.
- **Step 2: Building Upgrades** -> Implement energy-efficient upgrades to reduce energy consumption.
- **Step 3: Maximize Energy Efficiency** -> Optimize building systems and operations for maximum energy efficiency.
...
- **Step 5: Optimize Building Automation Systems and Grid Interactivity** -> Integrate building automation systems with the grid for optimized energy management.
- **Step 6: Assess Distributed Generation and Clean Power Production** -> Evaluate opportunities for on-site renewable energy generation.
- **Step 7: Utilize Energy Storage** -> Implement energy storage solutions to optimize energy use.
- **Step 8: Integrate Grid Interactivity and/or Microgrids** -> Enhance grid interactivity and consider microgrid integration.
- **Step 9: Evaluate Financial Considerations** -> Assess the financial implications of decarbonization strategies.

This framework provides a comprehensive roadmap for building owners and operators to reduce their carbon footprint and achieve sustainable operations.
...
**[Figure: Cumulative Annual Percent Therm Consumption]**

Type: chart

Description: This chart compares the cumulative annual percent therm consumption of a building with its design load. The key insight is that 80% of annual heating energy consumption occurs when the load is 25% or less.

Data Representation:

*   Category A: Annual Therms
...
*   Y-axis: Cumulative Annual Percent Therm Consumption
...
This chart provides valuable insights into the energy consumption patterns of a building, highlighting the importance of optimizing heating systems for low-load conditions.

**[Figure: Sample building annual heat load profile. Serving Peak Loads]**

Type: chart

Description: This chart compares the cumulative annual percent therm consumption and the annual load within percent load bin for a building's heat load profile. The key insight is that the majority of the building's heat load is served by the base load, with only a small portion being served by the peak load.

Data Representation:

*   Cumulative Annual Percent Therm Consumption: 100%
*   Metric: Annual Load within Percent Load Bin
*   Chart Type: Line
*   Units: Percent
...
This chart provides valuable insights into the building's heat load profile, highlighting the importance of serving the base load and the relatively small contribution of the peak load.
...
1. **Can it be more efficient?** -> This step involves assessing whether the current equipment can be made more efficient without replacing it.
2. **Equipment near end of life** -> If the equipment is nearing the end of its lifespan, it may be more cost-effective to replace it with electric equipment.
3. **Will retrofit meet loads (e.g., HHW temps)?** -> This step evaluates whether retrofitting the existing equipment will meet the required loads and temperatures.
4. **Pursue electric, heating and cooling load reduction** -> If retrofitting is not feasible, this step involves pursuing electric heating and cooling load reduction strategies.
5. **Upgrade Electrical and/or Structural Capacity** -> If load reduction is not possible, this step involves upgrading the electrical and/or structural capacity to accommodate electric equipment.
6. **Can the building accommodate new electric equipment?** -> This step assesses whether the building can accommodate new electric equipment, including available electrical capacity, available structural capacity, and available space (indoor, rooftop, or outdoor).
7. **Available Pathways** -> This step identifies the available pathways for electrification, including dual fuel or hybrid solutions, pursuing electric heating and cooling load reduction, and upgrading electrical and/or structural capacity.
8. **Add to Capital Plan for future retrofit trigger** -> If none of the above steps are feasible, this step involves adding the equipment to the capital plan for future retrofitting.

Flow Logic:

* If the equipment can be made more efficient, proceed to Step 2.
* If the equipment is nearing the end of its lifespan, proceed to Step 3.
* If retrofitting meets the required loads and temperatures, proceed to Step 4.
* If load reduction is not possible, proceed to Step 5.
* If the building cannot accommodate new electric equipment, proceed to Step 6.
* If none of the above steps are feasible, add the equipment to the capital plan for future retrofitting.

Key Components:

* **Electric** -> The electric option is considered throughout the decision-making process.
* **Fossil Fuel** -> The fossil fuel option is considered as an alternative to electric equipment.
* **Available Pathways** -> The available pathways for electrification are identified in Step 7.
...

{
  ...
  "decisions": [
    {
      "condition": "Can it be more efficient?",
      "yes": "Equipment near end of life",
      "no": "Will retrofit meet loads (e.g., HHW temps)?"
    }},
    {
      "condit...
...
Description: This figure illustrates a decision tree to determine when to electrify equipment. The process starts with the "Start Process" step and ends with the "End Process" step. The decision tree involves evaluating the energy source and making a decision based on that evaluation.

Process Steps:

1. Start Process -> Initiates the decision-making process.
2. Energy Source -> Evaluates the energy source of the equipment.
3. Decision -> Makes a decision based on the energy source evaluation.
4. End Process -> Concludes the decision-making process.
...
* Energy Source -> The energy source of the equipment being evaluated.
* Decision -> The decision made based on the energy source evaluation.
...

{
    ...
    "decisions": [{"condition": "Energy Source", "yes": "Decision", "no": "End Process"}}]
}
...
*   **Cover Page**: The cover page features a cityscape with a power grid overlay, symbolizing the integration of buildings with the electrical grid.
*   **Title**: The title "Grid-Interactive Buildings for Decarbonization: Design and Operation Resource Guide" clearly communicates the focus of the guide.
*   **Subtitle**: The subtitle "Design and Operation Resource Guide" indicates that the guide provides practical information for designing and operating grid-interactive buildings.
*   **ASHRAE Logo**: The ASHRAE logo is displayed on the cover page, indicating that the guide is published by the American Society of Heating, Refrigerating, and Air-Conditioning Engineers.

This guide is a valuable resource for anyone involved in the design, operation, or management of buildings, as it provides a comprehensive framework for maximizing the benefits of grid-interactive buildings while minimizing their carbon footprint.
...
```json
{
  ...
  "data": {
    ...
    "Package of Measures Option 2": [100, 90, 80, 70, 60, 50, 40, 30, 20]
  }}
}
```

This chart provides a clear comparison of the cumulative emissions reduction measures for two different packages of measures, highlighting the effectiveness of each package in reducing GHG emissions.

**[Figure: Example comparison of ERM packages]**

Type: chart

Description: This chart compares the cumulative emissions reduction measures for two different packages of measures, Option 1 and Option 2. The chart shows that both options result in a significant reduction in emissions, with Option 1 achieving a 50% reduction and Option 2 achieving a 50% reduction as well.
...
Units: Percentage of baseline emissions

Chart Generation Hint:

*   X-axis: ERM package
*   Y-axis: Percentage of baseline emissions
...
Description: The diagram illustrates a timeline for implementing emissions reduction measures, spanning from 2020 to 2030. It highlights key milestones and triggers for various initiatives aimed at reducing emissions.

Key Elements:

*   Timeline: -> A horizontal axis representing the years from 2020 to 2030.
*   Milestones: -> Vertical lines indicating specific events or deadlines, such as "Connect Thermal Storage - Water Tanks" in 2023 and "Deep Retrofit Floors - 4, 5, 6, 12, 14, & 15" in 2028.
*   Triggers: -> Arrows connecting milestones to indicate the sequence of events or dependencies between them.

This diagram provides a visual representation of the planned emissions reduction measures and their corresponding timelines, helping stakeholders understand the progression and interdependencies of these initiatives.
...
*   **Image**: A photo of several tall buildings with a blue sky and white clouds in the background.
...
- **Tagline**: "Building Efficiency Targeting Tool for Energy Retrofits" emphasizes the tool's purpose and scope.
- **Description**: A brief overview of the tool's capabilities and benefits, highlighting its ability to quantify energy, cost, and greenhouse gas (GHG) reduction potential and recommend energy efficiency measures for individual buildings or portfolios.

This diagram effectively communicates the essence of the BETTER tool, making it easy for users to understand its purpose and functionality at a glance.
...
Description: This chart compares the greenhouse gas emissions of different portfolio renovation scenarios against emissions reduction targets. The chart shows that the "Deep Efficiency, Deep Electrification" scenario has the lowest emissions, followed by the "Deep Efficiency, Moderate Electrification" scenario. The "Moderate Efficiency, Deep Electrification" scenario has higher emissions than the first two scenarios, while the "Moderate Efficiency, Moderate Electrification" scenario has the highest emissions.
...
```json
{
  ...
  "units": "thousand MTCO2e",
  "data": {
    "Scenario 1": [140, 120, 100, 80, 60, 40, 20, 0],
    "Scenario 2": [140, 130, 120, 110, 100, 90, 80, 70],
    "Scenario 3": [140, 130, 120, 110, 100, 90, 80, 70],
    "Scenario 4": [140, 130, 120, 110, 100, 90, 80, 70]
  }}
}
```

This chart provides a visual representation of the different portfolio renovation scenarios and their impact on greenhouse gas emissions. It allows for easy comparison of the scenarios and identification of the most effective strategies for reducing emissions.
...
Notes: This table presents a comprehensive overview of the benefits associated with various building systems and their components. It categorizes these benefits into four key areas: GHG savings, comfort, health/IAQ, and energy cost savings. The table provides a detailed breakdown of each system component, including its impact on these areas, allowing for a thorough analysis of the advantages and disadvantages of each option.
...
Notes: This table represents a benefits and impacts matrix for prioritization and implementation planning. It includes columns for costs, lifespan, maintenance, tenant disruption, when to implement, mid-cycle, and future refi. The table provides a structured way to evaluate different options based on their costs, benefits, and implementation considerations.

Structured Data (Machine Readable):

{
  "table_type": "benefits_impacts_matrix",
  "columns": ["COSTS", "LIFESPAN (YRS)", "MAINTENANCE", "TENANT DISRUPTION", "when to implement", "MID-CYCLE", "FUTURE REFI"],
  "data": [
    {"COSTS": "$$$$", "LIFESPAN (YRS)": 20, "MAINTENANCE": "medium", "TENANT DISRUPTION": "low", "when to implement": "as needed", "MID-CYCLE": "", "FUTURE REFI": ""}},
    {"COSTS": "$$$$", "LIFESPAN (YRS)": 20, "MAINTENANCE": "medium", "TENANT DISRUPTION": "high", "when to implement": "as needed", "MID-CYCLE": "", "FUTURE REFI": ""},
    {"COSTS": "$$$$", "LIFESPAN (YRS)": 15, "MAINTENANCE": "medium", "TENANT DISRUPTION": "low", "when to implement": "", "MID-CYCLE": "", "FUTURE REFI": ""},
    {"COSTS": "$$$$", "LIFESPAN (YRS)": 20, "MAINTENANCE": "low", "TENANT DISRUPTION": "medium", "when to implement": "if feasible", "MID-CYCLE": "", "FUTURE REFI": ""},
    {"COSTS": "$$$$", "LIFESPAN (YRS)": "10-20", "MAINTENANCE": "medium", "TENANT DISRUPTION": "low", "when to implement": "per HPD guidelines", "MID-CYCLE": "", "FUTURE REFI": ""},
    {"COSTS": "$$$$", "LIFESPAN (YRS)": 15, "MAINTENANCE": "medium", "TENANT DISRUPTION": "high", "when to implement": "per HPD guidelines", "MID-CYCLE": "", "FUTURE REFI": ""},
    {"COSTS": "$$$$", "LIFESPAN (YRS)": 15, "MAINTENANCE": "low", "TENANT DISRUPTION": "low", "when to implement": "", "MID-CYCLE": "", "FUTURE REFI": ""},
    {"COSTS": "$$$$", "LIFESPA...,
...
Description: The image depicts two individuals in high-visibility jackets and hard hats, engaged in maintenance work on an electrical panel. One person is kneeling, holding a tool, while the other stands behind, observing. The scene is set against a backdrop of a building's exterior, with a clear blue sky visible.

Key Elements:

- Electrical Panel -> The central focus of the maintenance activity.
- Maintenance Tools -> Various tools are scattered around the workers, indicating ongoing maintenance.
- High-Visibility Jackets and Hard Hats -> Safety gear worn by the workers to ensure safety during the maintenance process.

This diagram illustrates a moment of routine maintenance, highlighting the importance of regular upkeep for energy management and safety protocols in place for such activities.
...
Description: The figure presents a report cover page titled "Accelerating Electrification of California's Multifamily Buildings" with a subtitle "Policy Considerations and Technical Guidelines." The cover features a photo of a building on the left side, accompanied by text on the right side that describes the report's content.

Key Elements:

*   Title: "Accelerating Electrification of California's Multifamily Buildings"
*   Subtitle: "Policy Considerations and Technical Guidelines"
*   Photo of a building
*   Text describing the report's content
...
Description: The figure presents a comprehensive guide to energy efficiency and conservation in historic buildings, providing sound advice on practices, processes, and workflows that should be followed when performing energy efficiency and energy conservation improvement projects and programs involving historic buildings.
...
*   **Energy Guideline for Historic Buildings**: A resource for dealing with historic building constraints, providing guidance on energy efficiency upgrades while preserving the historic characteristics of an existing building.
*   **Collaboration with Preservation Experts**: Emphasizes the importance of working closely with local authorities to address challenges related to historic building renovations.
...
**[Figure: Building with Trees]** Type: diagram Description: The image depicts a tall building with multiple floors, each featuring balconies. In the foreground, trees are visible, while the background is a gray sky. Key Elements: - Building -> The central structure with balconies on each floor. - Trees -> In the foreground, adding a natural element to the scene. - Sky -> A gray backdrop that sets the tone for the image.
...
Description: The figure is a map of the western United States and Canada, with a search bar at the top. The map appears to be a zoomed-in view of a larger map, with the search bar allowing users to find specific locations within the region.

Key Elements:

* Map -> A visual representation of the western United States and Canada, showing state and province borders, major cities, and geographical features.
* Search bar -> A text input field at the top of the map, allowing users to search for specific locations within the region.
* Zoom controls -> A set of buttons or icons on the map, allowing users to zoom in or out of the map to view different levels of detail.

This figure is likely used in a context where users need to find specific locations within the western United States and Canada, such as in a travel planning or mapping application.
...
Description: The Justice40 Initiative Environmental Justice Fact Sheet is a visual representation of the initiative's goals and objectives. It provides an overview of the initiative's focus on environmental justice, highlighting its commitment to addressing the disproportionate impact of environmental hazards on low-income communities and communities of color.

Key Elements:

*   **Title**: The title of the fact sheet, "Justice40 Initiative Environmental Justice Fact Sheet," is prominently displayed at the top of the page.
*   **Logo**: The logo of the Office of Economic Impact and Diversity is located in the top-left corner of the page.
*   **Image**: A photograph of a wind farm is featured on the left side of the page, symbolizing the initiative's focus on renewable energy and sustainability.
*   **Text**: The fact sheet includes several paragraphs of text that provide an overview of the Justice40 Initiative, its goals, and its objectives. The text is organized into sections, each with a clear heading and concise bullet points.
*   **Graphics**: The fact sheet includes several graphics, including a bar chart and a pie chart, that illustrate the initiative's progress and achievements.

Overall, the Justice40 Initiative Environmental Justice Fact Sheet is a clear and concise visual representation of the initiative's goals and objectives. It effectively communicates the initiative's focus on environmental justice and its commitment to addressing the disproportionate impact of environmental hazards on low-income communities and communities of color.
...
This diagram provides a clear and concise visual representation of the benefits of electrifying buildings, making it an effective tool for decision-makers and stakeholders in the real estate industry.
