...
**[Figure: ASHRAE Position Document on Building Decarbonization Type: Image Description: This image shows a page from the ASHRAE Position Document on Building Decarbonization, which emphasizes the necessity of decarbonization and addresses key carbon-reduction principles and decarbonization strategies. Key Elements: - The title "ASHRAE Position Document on Building Decarbonization" is prominently displayed at the top of the page. - The document highlights the importance of decarbonization in addressing climate change and its impact on buildings and their systems. - The page includes a section on "Building Decarbonization" that discusses the need for decarbonization and its benefits. - The document also includes a section on "ASHRAE's Position" that outlines the organization's stance on building decarbonization. ]**
...
Type: Chart
Description: This chart compares the energy-related CO2 emissions in 2020 across different sectors.
Data Representation: - Residential (Indirect): 30% - Residential (Direct): 16% - Non-Residential (Indirect): 19% - Non-Residential (Direct): 8% - Building Construction (Embodied): 27% Metric: Energy-related CO2 emissions Chart
Type: Pie Chart Units: Percentage
Chart Generation Hint: - X-axis: Not applicable - Y-axis: Not applicable - Series/Groups: Residential (Indirect), Residential (Direct), Non-Residential (Indirect), Non-Residential (Direct), Building Construction (Embodied)
Structured Data (Machine Readable): { "chart_type": "pie", "metric": "energy-related CO2 emissions", "units": "percentage", "data": { "Residential (Indirect)": 30, "Residential (Direct)": 16, "Non-Residential (Indirect)": 19, "Non-Residential (Direct)": 8, "Building Construction (Embodied)": 27 } } ]
...
Description: This diagram illustrates the various stages involved in the life cycle of a building, from raw material supply to end-of-life disposal.
Key Elements: - Product Stage (A1 - A3) → Raw material supply - Construction Stage (A4 - A5) → Transport to site - Use Stage (B1 - B7) → Maintenance - End of Life Stage (C1 - C4) → Deconstruction / demolition - Circular Economy → Beyond the Building Life Cycle Stage (D) - Operational → Operational energy use - Operational → Operational water use ]
...
[Figure: (Untitled)
Type: Descriptive Diagram
Description: This diagram illustrates the various ways to reduce peak loads and increase efficiency in building systems. It highlights the importance of replacing equipment, systems, and controls to increase efficiency and reduce peak loads.
Key Elements: - Energy Efficiency → Reducing energy consumption through efficient systems and controls - Electrification → Replacing fossil-fuel-burning equipment with electric - Low GWP Fuels/Refrigerants → Using refrigerants with low global warming potential - Renewables & Storage → Transitioning to fuel choices such as solar, wind, water, geothermal, bioenergy, and nuclear - Grid Interactivity → Employing demand responsive technologies to increase grid stability contributing to resilience and recovery - Embodied Carbon → Specifying low GWP materials and sourcing local is becoming important as the industry considers whole life carbon instead of only operational.]
...
Type: Descriptive Diagram
Description: This diagram illustrates the steps involved in achieving decarbonization for existing buildings.
Key Elements: - Establish Framework → Set goals and baseline - Perform Assessment → Decarbonization focus and evaluation tools - Prioritize Measures → Evaluate/reduce loads, maximize efficiency, electrify, optimize controls, consider generation and storage, calculate carbon impact, package measures, determine financing - Draft Decarbonization Plan → Summarize measures and triggers, project emissions, determine infrastructure impacts - Implement Decarbonization Plan → Minimize operational disruptions, monitor systems, communicate with occupants, plan site logistics - Track and Report Performance → Measure installed performance, measure ongoing performance, perform O&M procedures]
...
Type: Descriptive Diagram
Description: This diagram illustrates the various building systems that play a crucial role in building decarbonization, including community wind turbines, efficient heat pump HVAC, high-performance envelope, high-performance windows, building controls, efficient electric water heater, onsite renewables and storage, efficient electric appliances and lighting.
Key Elements: - Community Wind Turbines → Generate renewable energy - Efficient Heat Pump HVAC → Provides heating, ventilation, and air conditioning while minimizing carbon footprint - High-Performance Envelope → Reduces heat loss and gain through advanced insulation and window technologies - High-Performance Windows → Minimizes heat transfer and maximizes natural light - Building Controls → Optimizes energy usage by controlling lighting, heating, and cooling systems - Efficient Electric Water Heater → Uses electricity efficiently to heat water - Onsite Renewables and Storage → Generates and stores renewable energy on-site - Efficient Electric Appliances and Lighting → Reduces energy consumption through the use of energy-efficient appliances and lighting. ]
...
Key Elements: - U.S. EPA eGRID Database → A database that includes annual historical GHG emission factors at the national, subregional, and utility-scale levels. - NREL Cambium Database → A database that provides modeled, forward-looking hourly emissions data for electricity generation across multiple grid scenarios. - UNFCCC Harmonized Grid Emission Factor Data Set → A database that lists grid emission factors outside of the United States divided by country/territory/island. - Other International Emission Factors → A list of international emission factors, including Electricity Maps, Gridwatch Web app, and Canadian government publishes Canadian emission factors by Province/Territory. ]
...
Type: Chart
Description: This chart compares the end-use breakdown of energy and GHG emissions in a building.
Data Representation: - Heating: 44% - Cooling: 15% - Lighting: 10% - Fans: 8% - Pumps: 5% - Plug Loads: 4% - Elevators: 3% - Hot Water: 2% - Heat Rejection: 1% Metric: Energy and GHG emissions Chart
Type: Donut Units: Percentage
Chart Generation Hint: - X-axis: Not applicable - Y-axis: Not applicable - Series/Groups: Energy and GHG emissions
Structured Data (Machine Readable): { "chart_type": "donut", "metric": "energy and GHG emissions", "units": "percentage", "data": { "Heating": 44, "Cooling": 15, "Lighting": 10, "Fans": 8, "Pumps": 5, "Plug Loads": 4, "Elevators": 3, "Hot Water": 2, "Heat Rejection": 1 } } ]
...
Data Representation: - Hour of Day: 0-24 - Day of Year: 1-365 - Metric: Electricity Demand (kW) - Chart
Type: Heat Map - Units: kW
Chart Generation Hint: - X-axis: Day of Year (1-365) - Y-axis: Hour of Day (0-24) - Series/Groups: Electricity Demand (kW)
Structured Data (Machine Readable): { "chart_type": "heat_map", "metric": "electricity_demand", "units": "kW", "data": { "day_of_year": [1, 2, ..., 365], "hour_of_day": [0, 1, ..., 24], "electricity_demand": [0.0, 0.1, ..., 50.0] } } ]

[Figure: Average hourly building demand vs. grid emission factors
Type: Chart
Description: This chart compares the average hourly building demand with grid emission factors, specifically focusing on net building demand (with PV), marginal carbon, and high carbon and cost hours.
Data Representation: - Net building demand (with PV): 0.5 - Marginal carbon: 0.3 - High carbon and cost hours: 0.2 Metric: Energy consumption Units: Kilowatt-hours (kWh) Chart
Type: Line Chart X-axis: Hour of the day Y-axis: Energy consumption (kWh) Series/Groups: Net building demand (with PV), Marginal carbon, High carbon and cost hours
Chart Generation Hint: - X-axis: Hour of the day (0-24) - Y-axis: Energy consumption (kWh) (0-1.5) - Series/Groups: Net building demand (with PV), Marginal carbon, High carbon and cost hours
Structured Data (Machine Readable): { "chart_type": "line_chart", "metric": "energy_consumption", "units": "kWh", "data": { "net_building_demand": 0.5, "marginal_carbon": 0.3, "high_carbon_and_cost_hours": 0.2 } } ]
...
Type: Image
Description: The image shows a cityscape with a power line and a building in the foreground.
Key Elements: - Power line → A power line is visible in the foreground, with several towers and wires. - Building → A building is visible in the foreground, with a flat roof and several windows. - Cityscape → The cityscape is visible in the background, with several skyscrapers and buildings. ]
...
Type: Chart
Description: This chart compares the heating and cooling loads of a building over time, highlighting the thermal overlap between the two.
Data Representation: - Heating: 2000 kBtu/hr - Cooling: 1700 kBtu/hr - Metric: Energy consumption - Chart
Type: Line chart - Units: kBtu/hr
Chart Generation Hint: - X-axis: Time (hours) - Y-axis: Energy consumption (kBtu/hr) - Series/Groups: Heating, Cooling
Structured Data (Machine Readable): { "chart_type": "line", "metric": "energy_consumption", "units": "kBtu/hr", "data": { "heating": 2000, "cooling": 1700 } } ]
...
Process Steps: 1. Foundational Data → Collect and analyze data 2. Building Upgrades → Reduce electrical, heating, and cooling loads 3. Maximize Energy Efficiency → Electrify space conditioning and water heating systems 4. Optimize Building Automation Systems and Grid Interactivity → Assess distributed generation and clean power production 5. Optimize Energy Performance → Integrate grid interactivity and or microgrids 6. Utilize Energy Storage → Consider embodied carbon 7. Evaluate Resources → Evaluate financial considerations 8. Evaluate Financial Considerations → Evaluate financial considerations
Flow Logic: - Foundational Data → Building Upgrades - Decision: If optimize building automation systems and grid interactivity → Optimize Building Automation Systems and Grid Interactivity, else → Maximize Energy Efficiency
Key Components: - Foundational Data → Collect and analyze data - Building Upgrades → Reduce electrical, heating, and cooling loads - Maximize Energy Efficiency → Electrify space conditioning and water heating systems Structured Flow (Machine Readable): { "type": "flow_diagram", "steps": ["Foundational Data", "Building Upgrades", "Maximize Energy Efficiency", "Optimize Building Automation Systems and Grid Interactivity", "Optimize Energy Performance", "Utilize Energy Storage", "Evaluate Resources", "Evaluate Financial Considerations"], "flow": [["Foundational Data", "Building Upgrades"], ["Building Upgrades", "Maximize Energy Efficiency"], ["Maximize Energy Efficiency", "Optimize Building Automation Systems and Grid Interactivity"], ["Optimize Building Automation Systems and Grid Interactivity", "Optimize Energy Performance"], ["Optimize Energy Performance", "Utilize Energy Storage"], ["Utilize Energy Storage", "Evaluate Resources"], ["Evaluate Resources", "Evaluate Financial Considerations"]], "decisions": [{"condition": "optimize building automation systems and grid interactivity", "yes": "Optimize Building Automation Systems and Grid Interactivity", "no": "Maximize Energy Efficiency"}] } ]
...
[Figure: Cumulative Annual Percent Therm Consumption Type: Chart Description: The chart compares the cumulative annual percent therm consumption of a 60-year-old building with a mild climate, showing that 80% of annual heating energy consumption occurs when the load is 25% or less. Data Representation: - Annual Therms: 125,000 ft2 (11,600 m2) - Design 22 Btu/ft2 (250 W/m2) peak - Actual 13 Btu/ft2 (148 W/m2) peak Metric: Cumulative Annual Percent Therm Consumption Chart Type: Bar Units: Percent Chart Generation Hint: - X-axis: Percent of Design Load - Y-axis: Cumulative Annual Percent Therm Consumption - Series/Groups: Annual Therms Structured Data (Machine Readable): { "chart_type": "bar", "metric": "cumulative annual percent therm consumption", "units": "percent", "data": { "annual therms": 125000, "design 22 btu/ft2 (250 w/m2) peak": 13, "actual 13 btu/ft2 (148 w/m2) peak": 13 } }]

The chart shows that 80% of annual heating energy consumption occurs when the load is 25% or less, indicating that the building's heating system is most efficient when operating at lower loads. The chart also highlights the difference between the design peak load and the actual peak load, with the actual peak load being significantly lower than the design peak load. This suggests that the building's heating system may be oversized for its current needs.
]
...
Data Representation: - Annual Therms: 100% - Cumulative Annual Percent Consumption: 100% Metric: Annual Therm Consumption Chart
Type: Line Chart Units: Percent
Chart Generation Hint: - X-axis: Percent of Design Load - Y-axis: Cumulative Annual Percent Consumption - Series/Groups: Annual Therms, Cumulative Annual Percent Consumption
Structured Data (Machine Readable): { "chart_type": "line_chart", "metric": "annual_therm_consumption", "units": "percent", "data": { "annual_therms": 100, "cumulative_annual_percent_consumption": 100 } }
]
...
Type: Flow Diagram
Description: This flow diagram outlines the decision-making process for determining when to electrify equipment, considering factors such as capital plan upgrade schedule, life cycle evaluations of retrofit, and available funding.
Process Steps: 1. Follow Capital Plan Upgrade Schedule → Determine if the equipment is due for upgrade according to the capital plan schedule. 2. Life Cycle Evaluations of Retrofit → Assess the life cycle costs and benefits of retrofitting the equipment. 3. Available Funding → Determine if there is sufficient funding available for the retrofit.
Flow Logic: - If the equipment is due for upgrade and there is sufficient funding, proceed with the retrofit. - If the equipment is not due for upgrade or there is insufficient funding, consider alternative options such as upgrading electrical and/or structural capacity.
Key Components: - Capital Plan Upgrade Schedule → A schedule outlining the planned upgrades for equipment. - Life Cycle Evaluations of Retrofit → An assessment of the costs and benefits of retrofitting equipment over its life cycle. - Available Funding → The amount of funding available for the retrofit. Structured Flow (Machine Readable): { "type": "flow_diagram", "steps": ["Follow Capital Plan Upgrade Schedule", "Life Cycle Evaluations of Retrofit", "Available Funding"], "flow": [["Follow Capital Plan Upgrade Schedule", "Life Cycle Evaluations of Retrofit"], ["Life Cycle Evaluations of Retrofit", "Available Funding"]], "decisions": [{"condition": "Equipment is due for upgrade and there is sufficient funding", "yes": "Proceed with retrofit", "no": "Consider alternative options"}] }
]

**Figure: Decision Tree Type: Flow Diagram Description: This decision tree guides the determination of when to electrify equipment, considering factors such as energy source and process start. Process Steps: 1. End Process → The final step in the decision-making process. 2. Decision → A critical point where the decision to electrify is made based on the energy source. 3. Energy Source → The type of energy source available for electrification. 4. Start Process → The initial step in the electrification process. Flow Logic: - End Process → Decision - Decision: If Energy Source is renewable → Electrify, else → Do not electrify Key Components: - Energy Source → Determines the feasibility of electrification Structured Flow (Machine Readable): { "type": "flow_diagram", "steps": ["End Process", "Decision", "Energy Source", "Start Process"], "flow": [["End Process", "Decision"], ["Decision", "Energy Source"], ["Energy Source", "Start Process"]], "decisions": [{"condition": "Energy Source is renewable", "yes": "Electrify", "no": "Do not electrify"}] }**
...
Type: Image
Description: This image shows a book cover titled "Grid-Interactive Buildings for Decarbonization: Design and Operation Resource Guide." The cover features a cityscape with a grid of power lines and a wind turbine in the foreground.
Key Elements: - Book Title: "Grid-Interactive Buildings for Decarbonization: Design and Operation Resource Guide" - Cityscape: A city skyline with skyscrapers and buildings - Power Lines: A grid of power lines stretching across the city - Wind Turbine: A wind turbine in the foreground, symbolizing renewable energy - ASHRAE Logo: The American Society of Heating, Refrigerating, and Air-Conditioning Engineers (ASHRAE) logo is displayed on the cover, indicating the organization's involvement in the guide. ]
...
Data Representation: - Package 1: 50% - Package 2: 50% - Metric: Cumulative Emissions Reduction - Chart
Type: Bar Chart - Units: Percentage (%)
Chart Generation Hint: - X-axis: ERMs (Energy-Related Measures) - Y-axis: Cumulative Emissions Reduction (%) - Series/Groups: Package 1, Package 2
Structured Data (Machine Readable): { "chart_type": "bar_chart", "metric": "cumulative_emissions_reduction", "units": "%", "data": { "Package 1": 50, "Package 2": 50 } } ]

[Figure: Example comparison of ERM packages
Type: Chart
Description: This chart compares the cumulative emissions reduction measures for two different packages of measures, Option 1 and Option 2.
Data Representation: - Option 1: 50% - Option 2: 50% Metric: CO2-equivalent emissions reduction Measures: - ERM 1: Lighting and HVAC Upgrades, Geothermal Heat Pump Heating - ERM 2: Envelope Improvements, Lighting and HVAC Upgrades, Air Source Heat Pump Heating Chart
Type: Bar Units: %
Chart Generation Hint: - X-axis: ERM packages - Y-axis: CO2-equivalent emissions reduction - Series/Groups: Option 1, Option 2
Structured Data (Machine Readable): { "chart_type": "bar", "metric": "CO2-equivalent emissions reduction", "units": "%", "data": { "Option 1": 50, "Option 2": 50 } }
]
...
Type: Descriptive Diagram
Description: The diagram illustrates a timeline for implementing various measures to reduce emissions, with specific triggers and milestones marked along the way.
Key Elements: - Data Strategy - Connect Everything → Represents the overarching strategy for data management and integration. - Replace Primary AHU with High Energy Recovery → Indicates a plan to upgrade or replace air handling units (AHUs) with more energy-efficient models. - Deep Retrofit Floors - 2,3,7, 8, & 9 → Highlights the floors within a building that are scheduled for deep retrofitting, which involves significant renovations to improve energy efficiency. - Move To Ambient Loop (Add ASHP And Dry Coolers) → Suggests transitioning to an ambient loop system, incorporating air source heat pumps (ASHP) and dry coolers for more efficient heating and cooling. - Enable Data And AI Solutions → Emphasizes the importance of leveraging data and artificial intelligence (AI) solutions to optimize energy usage and management. - Connect Thermal Storage - Water Tanks → Involves connecting thermal storage systems, specifically water tanks, to enhance energy storage capabilities. - Connect To 555 GW To Share Energy → Indicates a plan to connect to a 555 GW energy-sharing network, facilitating the exchange of energy between different sources. - Deep Retrofit Floors - 10, 11, 13, 16, & 17 → Identifies additional floors within the building that are slated for deep retrofitting. - Deep Retrofit Floors - 4, 5, 6, 12, 14, & 15 → Lists more floors that will undergo deep retrofitting. - Complete Ambient Loop - 100% Electric Building → Represents the ultimate goal of achieving a fully electric building with a complete ambient loop system. ]
...
**[Figure: Framework for Greenhouse Gas Emissions Reduction Planning: Building Portfolios Type: Image Description: The image shows a cover page for a document titled "Framework for Greenhouse Gas Emissions Reduction Planning: Building Portfolios." The cover features a photo of several skyscrapers against a blue sky with white clouds. Key Elements: - Skyscrapers → Representing buildings - Blue sky with white clouds → Symbolizing a clean environment - Title and logo → Indicating the document's purpose and origin]**

This image is classified as Type 5 — Photo / Cover / Image. It serves as the cover page for a document focused on reducing greenhouse gas emissions in building portfolios. The image effectively conveys the theme of environmental sustainability in urban development through its depiction of skyscrapers set against a clear blue sky with white clouds.
...
Type: Descriptive Diagram
Description: The Department of Energy's BETTER software toolkit enables building operators to quickly and easily identify the most cost-saving energy efficiency measures in buildings and portfolios using readily available building and energy data.
Key Elements: - BETTER logo → represents the software toolkit - Building Efficiency Targeting Tool for Energy Retrofits → title of the software toolkit - U.S. Department of Energy → organization that developed the software toolkit]
...
Type: Chart
Description: This chart compares four different scenarios for reducing greenhouse gas emissions from the electricity sector in the United States, with a focus on meeting two reduction targets: 50% and 80% by 2040.
Data Representation: - Scenario 1: Deep Efficiency, Deep Electrification - Scenario 2: Deep Efficiency, Moderate Electrification - Scenario 3: Moderate Efficiency, Deep Electrification - Scenario 4: Moderate Efficiency, Moderate Electrification Metric: Greenhouse gas emissions (thousand MTCO2e) Chart
Type: Line chart Units: Thousand MTCO2e
Chart Generation Hint: - X-axis: Year (2020-2040) - Y-axis: Greenhouse gas emissions (thousand MTCO2e) - Series/Groups: Scenario 1, Scenario 2, Scenario 3, Scenario 4
Structured Data (Machine Readable): { "chart_type": "line", "metric": "greenhouse gas emissions", "units": "thousand MTCO2e", "data": { "Scenario 1": [140, 120, 100, 80, 60, 40, 20], "Scenario 2": [140, 120, 100, 80, 60, 40, 20], "Scenario 3": [140, 120, 100, 80, 60, 40, 20], "Scenario 4": [140, 120, 100, 80, 60, 40, 20] } }
]
...
[Figure: benefits
Type: Table
Data: | BUILDING SYSTEM | SYSTEM COMPONENT | GHG SAVINGS | COMFORT | HEALTH/IAQ | ENERGY COST SAVINGS | | --- | --- | --- | --- | --- | --- | | envelope | Roof Insulation | low | low | $ | $ | | envelope | Windows/Doors | high | medium | $ | $ | | envelope | Air Sealing & Weatherization | high | medium | $ | $ | | envelope | Exterior Wall Insulation | high | medium | $ | $ | | HVAC | Heating System Upgrades | medium | medium | $ | $ | | HVAC | Electrify Heating | high | high | $ | $ | | HVAC | Pipe Insulation | medium | low | $ | $ | | HVAC | Ventilation Upgrades | medium | high | $ | $ | | domestic hot water | Electrify Hot Water Heating | low | high | $ | $ | | domestic hot water | Plumbing Fixture Upgrades | low | low | $ | $ | | lighting | Common Area & Exterior Upgrades | low | medium | $ | $ | | lighting | In-Unit Upgrades | low | medium | $ | $ | | plug loads | Appliance Upgrades | low | low | $ | $ | | plug loads | Electrify Cooking | medium | high | $ | $ | | plug loads | Electrify Laundry | low | medium | $ | $ | | renewables | Solar PV | low | low | $ | $ |
Notes: This table presents a comprehensive overview of the benefits associated with various building systems and their components. The table is organized into six main categories: envelope, HVAC, domestic hot water, lighting, plug loads, and renewables. Each category contains multiple components, and for each component, the table provides information on GHG savings, comfort, health/IAQ, and energy cost savings. The data is presented in a clear and concise manner, making it easy to compare the benefits of different components within each category. Overall, this table serves as a valuable resource for individuals seeking to understand the advantages of various building systems and their components.
]

[Figure: Example benefits & impacts matrix for prioritization and implementation planning
Type: Table
Data: | COSTS | LIFESPAN (YRS) | MAINTENANCE | TENANT DISRUPTION | when to implement | |------|-------------|-------------|------------------|-------------------| | $$$$ | 20 | medium | low | as needed | | $$$$ | 20 | medium | high | as needed | | $$$$ | 15 | medium | low | | | $$$$ | 20 | low | medium | if feasible | | $$$$ | 10–20 | medium | low | per HPD guidelines | | $$$$ | 15 | medium | high | per HPD guidelines | | $$$$ | 15 | low | low | | | $$$$ | 15 | medium/high (ERV) | high | per HPD guidelines | | $$$$ | 10 | medium | low | per HPD guidelines | | $$$$ | 10 | low | low | | | $$$$ | 15–20 | low | low | | | $$$$ | 15–20 | low | medium | | | $$$$ | 15 | low | medium | as needed | | $$$$ | 10 | low | high | per HPD guidelines | | $$$$ | 10 | medium | low | as needed | | $$$$ | 20–25 | low | low | per HPD SWF |
Notes: This table represents a benefits and impacts matrix for prioritization and implementation planning. It lists various costs, lifespans, maintenance requirements, tenant disruption levels, and implementation timelines for different energy-efficient measures. The table provides a structured approach to evaluating and prioritizing energy-saving initiatives based on their costs, benefits, and implementation considerations.
]
...
Type: Image
Description: The image shows two workers in high-visibility jackets and hard hats inspecting electrical equipment.
Key Elements: - Worker 1 → Inspecting electrical equipment - Worker 2 → Assisting Worker 1 - Electrical equipment → Being inspected by the workers ]
